...
export const metadata = {
  title: page?.title ?? "Privacy Policy | Gautam Plastic",
  description: page?.description ?? "Privacy policy for Gautam Plastic.",
};
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <p className="text-sm font-semibold uppercase tracking-[0.35em] text-[#FF7A00]">Privacy Policy</p>
